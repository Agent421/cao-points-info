...
var current_points  = document.getElementById("target_text");


hl_count.addEventListener('input', UpdateHL);
ol_count.addEventListener('input', UpdateOL);
current_points.addEventListener('input', pointsUpdate);

function UpdateHL(e) {
 hl_count = Number(hl_count.value);
 find_points_needed();
}

function UpdateOL(e) {
 ol_count = Number(ol_count.value);
 find_points_needed();
}
...
function pointsUpdate(e) {
 current_points = Number(current_points.value);
